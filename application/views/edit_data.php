...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <h2 class="box-title">Ubah data Diri</h2>
      <h4>Data ini digunakan untuk kontak pribadi dan informasi lainnya yang dibutuhkan untuk menggunakan layanan</h4>
            ...
            <form role="form" method="post">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" name= "username" class="form-control" id="exampleInputEmail1" disabled value="<?php echo $detail->username ?>">
                </div>  
                <div class="form-group">
                  <label for="exampleInputPassword1">Password</label>
                  <input type="text" name= "password" class="form-control" id="exampleInputPassword1" placeholder="********" disabled>
                   <a href="<?php echo site_url("/ubahpassword") ?>"  target="_blank">Ubah Password</a>
                </div>

                <div class="form-group">
                  <label for="exampleInputPassword1">Nama Lengkap</label>
                  <input type="text" name= "namalengkap" class="form-control" id="exampleInputPassword1" value="<?php echo $detail->nama_customer ?>">
                </div>
                <div class="form-group">
                  <label for="exampleInputPassword1">Email</label>
                  <input type="text" name= "email" class="form-control" id="exampleInputPassword1" value="<?php echo $detail->email ?>">
                </div>
                <div class="form-group">
                  <label for="exampleInputPassword1">Nomer HP</label>
                  <input type="text" name= "nohp" class="form-control" id="exampleInputPassword1" value="<?php echo $detail->nohp ?>">
                </div>                
                <div class="form-group">
                  <label for="exampleInputPassword1">Alamat</label>
                  <input type="text" name= "alamat" class="form-control" id="exampleInputPassword1" value="<?php echo $detail->alamat ?>">
                </div>
              </div>                
              <!-- /.box-body -->

              <div class="box-footer">
                <button type="submit" class="btn btn-primary" name="ubahdata">Ubah Data Diri</button>
              </div>
           </div>   
    </section>  
