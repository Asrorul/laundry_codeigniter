    ...
    <div class="row">
      ...
      <div class="box">
            <div class="box-header">
              <center><h2 >Daftar Transaksi</h2></center><br>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer"><div class="row"><div class="col-sm-6"></div><div class="col-sm-6"></div></div><div class="row"><div class="col-sm-12"><table id="example2" class="table table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="example2_info">
                ...
                <?php $no = 1; foreach($admin->result() as $list){ ?>
                <tr role="row" class="odd">
                
                <form action="" method="post">
                  <td class="sorting_1"><a href="<?php echo site_url('detailtransaksi/').$list->id_transaksi ?>" target="_blank"><?php echo $list->id_transaksi ?></a></td>
                  <input type="text" name= "idtransaksi" value="<?php echo $list->id_transaksi ?>" hidden>
                  <td><center>
                      <div class="form-group">
                        <?php if($list->status_cucian == '2'){ echo $list->berat_cucian. " Kg"; 
                         } else{ ?>
                        <input type="text" name="berat" class="form-control" id="exampleInputPassword1" value="<?php echo $list->berat_cucian ?>" > <?php } ?>
                      </div>
                    </center></td>
                  <td><center>
                      <div class="form-group">
                  ...
                  <td><?php echo $list->pewangi ?></td>
                  <td><?php echo $list->tanggal_pesan, " pada pukul ". $list->jam_pesan ?></td>
                  <td><div class="form-group">
                  <?php if($list->status_cucian == '2'){ echo "Transaksi Selesai" ?>&nbsp&nbsp &#10004;
                  <?php }else{ ?>
                  <select class="form-control" name="statuscucian">
                    <option value="0"<?php if($list->status_cucian == '0') echo ' selected="selected"';?>>Menunggu penjemputan</option>
                    <option value="1" <?php if($list->status_cucian == '1') echo ' selected="selected"';?>>Sedang dalam proses</option>
                    <option value="2" <?php if($list->status_cucian == '2') echo ' selected="selected"';?>>Transaksi Selesai</option>
                  </select>
                  <?php } ?>
                </div></td>
                  <td><?php if($list->status_cucian == '2'){ ?>
                    <button type="submit" name="ubahdata" class="btn btn-primary" disabled>update pesanan</button>
                    <?php }else{ ?>
                    <button type="submit" name="ubahdata" class="btn btn-primary" >update pesanan</button>
                    <?php } ?>
                  </td>
                </form>
                </tr>
                ...
                <label>*Klik kode transaksi untuk melihat detil transaksi</label>
